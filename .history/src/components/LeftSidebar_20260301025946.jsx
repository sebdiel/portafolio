...
function LeftSidebar() {
  ...
  return (
    <div
      className={`fixed left-0 top-0 h-screen w-70 flex flex-col justify-between items-center px-6 py-10 z-50 transition-all duration-300 ${
        scrolled
    ...
    >
      ...
      <div className="flex flex-col items-center gap-4">
        <img
          src={foto}
          alt="Sebastián Gómez"
          className="w-50 h-50 object-cover rounded-full border-4 border-cyan-400 shadow-[0_0_25px_rgba(56,189,248,0.4)] transition duration-500 hover:scale-105"
        />
