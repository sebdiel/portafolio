...
function LeftSidebar() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      for (let id of sections) {
        ...
        if (el) {
          ...
          // Si el top de la sección está dentro del viewport (ajustado)
    ...
    handleScroll(); // para inicializar activeSection al cargar
  ...
  const handleClick = (id) => {
    ...
    if (el) {
      ...
      // No necesitamos setActiveSection aquí, el scroll lo hará
    }
  };
